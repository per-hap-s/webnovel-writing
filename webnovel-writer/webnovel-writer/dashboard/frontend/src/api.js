...
CODE_MESSAGE_MAP.VERIFICATION_ALREADY_RUNNING = '当前已有一个多子代理验证在运行，请先等待完成。'
CODE_MESSAGE_MAP.VERIFICATION_RUN_NOT_FOUND = '未找到对应的验证运行记录。'
CODE_MESSAGE_MAP.VERIFICATION_ARTIFACT_NOT_FOUND = '未找到对应的验证产物。'
CODE_MESSAGE_MAP.VERIFICATION_LOG_NOT_FOUND = '未找到对应的验证日志。'
CODE_MESSAGE_MAP.VERIFICATION_LAUNCH_FAILED = '多子代理验证启动失败。'
CODE_MESSAGE_MAP.VERIFICATION_RESULT_INVALID = '验证结果文件损坏，无法解析。'
...
export function fetchText(path, params = {}, options = {}) {
    return requestText(path, { ...options, params, method: 'GET' })
}
