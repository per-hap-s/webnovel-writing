...
- **Taxonomy**: `${WEBNOVEL_APP_ROOT}/references/reading-power-taxonomy.md`
- **Genre Profile**: `${WEBNOVEL_APP_ROOT}/references/genre-profiles.md`
- **Contract v2**: `${WEBNOVEL_APP_ROOT}/skills/webnovel-write/references/step-1.5-contract.md`
- **Shared References**: `${WEBNOVEL_APP_ROOT}/references/shared/` 为单一事实源；如需枚举/扫描参考文件，遇到 `<!-- DEPRECATED:` 的文件一律跳过。
...
```bash
# 仅使用 WEBNOVEL_APP_ROOT，避免多路径探测带来的误判
...
SCRIPTS_DIR="${WEBNOVEL_APP_ROOT}/scripts"
