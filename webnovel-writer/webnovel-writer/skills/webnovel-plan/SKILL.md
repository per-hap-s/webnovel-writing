...
if [ -z "${WEBNOVEL_APP_ROOT}" ] || [ ! -d "${WEBNOVEL_APP_ROOT}/skills/webnovel-plan" ]; then
  echo "ERROR: 未设置 WEBNOVEL_APP_ROOT 或缺少目录: ${WEBNOVEL_APP_ROOT}/skills/webnovel-plan" >&2
  exit 1
fi
export SKILL_ROOT="${WEBNOVEL_APP_ROOT}/skills/webnovel-plan"
